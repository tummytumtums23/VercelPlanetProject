...
export class UranusService implements OnDestroy {
  ...
  public resize(): void {
    ...
    return new THREE.Mesh(
      ...
      new THREE.MeshPhongMaterial({
        map:         THREE.ImageUtils.loadTexture('assets/images/uranusmap.jpg'),
        bumpMap:     THREE.ImageUtils.loadTexture('assets/images/uranusbumpmap.jpg'),
        bumpScale:   0.005,
